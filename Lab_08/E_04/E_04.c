...
// la differenza sta nel fatto che rimanendo sempre gli stessi thread io devo avere un semaforo per ogni thread perchè dato che sono sempre quelli se ho un 
//thread che è sempre più veloce degli altri due il mio albero delle precedenze non sarebbe rispettato
